...
export const temporalFeltVocabulary: FeltVocabulary = {
...
export function selectIntensity(
  ...
  if (value < thresholds.subtle) return 'subtle';
 ...
 */
export function getTemporalFelt(
  type: keyof typeof temporalFeltVocabulary,
