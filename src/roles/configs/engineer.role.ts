...
export const engineerRole: RoleKnowledgeDomain = {
  // === Identity ===
  roleId: 'engineer',
  displayName: 'Engineer',
  description:
    'Software developer building AI-native tools (Brain Garden, Zosia), navigating career pivots after 20+ years, managing TypeScript monorepo complexity, working at Scala while exploring freelance opportunities.',
