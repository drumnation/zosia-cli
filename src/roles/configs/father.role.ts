...
export const fatherRole: RoleKnowledgeDomain = {
  // === Identity ===
  roleId: 'father',
  displayName: 'Father',
  description:
    'Divorced father with week-on/week-off custody arrangement, raising a pre-teen (Jules), balancing work demands with quality parenting time, navigating co-parenting dynamics.',
