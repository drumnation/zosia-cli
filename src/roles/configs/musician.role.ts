...
export const musicianRole: RoleKnowledgeDomain = {
  // === Identity ===
  roleId: 'musician',
  displayName: 'Musician',
  description:
    'Formally trained musician (music theory & composition degree) with multi-instrumental background: jazz drumset, tabla, piano, choir. Currently exploring prog metal/djent drumming, seeking creative flow states, exploring AI tools for composition.',
