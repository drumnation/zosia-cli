 ...
 */
function generateRoleTexture(roles, emotion) {
 ...
 */
export function synthesizeMindState(layers) {
 ...
 */
export function formatMindStateForPrompt(mindState) {
    const parts = [];
 ...
 */
export function generateExperienceBridgePrompt(mindState) {
    return `
---
