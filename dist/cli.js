...
import { notifyIfUpdateAvailable, runUpdate } from './updater.js';
...
import { parseAttachments, getImageAttachments, } from './attachments.js';
import { initWeLayerPool, shutdownWeLayerPool, detectClaudeCodeAuth, refreshClaudeCodeStatus, getGraphitiStatus, getGraphitiStatusAsync, } from './we-layer.js';
import { login as authLogin, logout as authLogout, getSession as getAuthSession, getCurrentUser, isAuthenticated, } from './auth.js';
import { loadConfig, setPreferredProvider, setOpenAIKey, clearOpenAIKey, getConfigSummary, setOpenRouterKey, clearOpenRouterKey, getConsciousMindConfig, setConsciousMindModel, setConsciousMindTemperature, setConsciousMindMaxTokens, getCustomPrompts, setCustomPrompt, clearCustomPrompt, clearAllCustomPrompts, getCostTracking, resetCostTracking, resetToDefaults, getCachedModels, clearModelCache, } from './config.js';
import { filterConversationalModels, filterFreeModels, sortModelsByCost, formatModelDisplay, RECOMMENDED_CONSCIOUS_MODELS, DEFAULT_CONSCIOUS_MODEL, } from './model-service.js';
 ...
 */
async function handlePrintMode(message, options) {
...
configCommand
    ...
    await setPreferredProvider(normalizedProvider);
...
configCommand
    ...
    const validTypes = ['conscious', 'subconscious', 'identityKernel'];
