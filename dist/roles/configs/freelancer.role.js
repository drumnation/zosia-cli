 ...
 */
export const freelancerRole = {
    // === Identity ===
    roleId: 'freelancer',
    displayName: 'Freelancer',
    description: 'Side-hustle consultant at $250/hr focusing on React/TypeScript architecture, medical supply domain expertise, building AI-native portfolio to potentially go full-time independent.',
    // === Detection ===
    keywords: [
        'freelance',
        'client',
