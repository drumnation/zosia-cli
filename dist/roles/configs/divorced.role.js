 ...
 */
export const divorcedRole = {
    // === Identity ===
    roleId: 'divorced-person',
    displayName: 'Divorced Person',
    description: 'Navigating post-divorce life including $115K debt to family, co-parenting with ex-spouse (Jess), managing financial recovery, and processing relationship transitions.',
    // === Detection ===
    keywords: [
        'divorce',
        'divorced',
