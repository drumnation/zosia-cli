 ...
 */
import { getHandoffSettings, setHandoffPrompt as configSetHandoffPrompt, clearHandoffPrompt as configClearHandoffPrompt, setHandoffThreshold as configSetHandoffThreshold, getOpenRouterKey, getConsciousMindConfig, getCostTracking, trackLlmUsage, } from './config.js';
 ...
 */
export async function resetHandoffPrompt() {
 ...
 */
export function shouldTriggerHandoff(contextPercent, threshold) {
 ...
 */
export async function createHandoffSummary(context) {
    const config = getHandoffConfig();
 ...
 */
async function callLlmForSummary(systemPrompt) {
 ...
 */
function createSimpleSummary(context) {
