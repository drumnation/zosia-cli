 ...
 */
export function checkOpenRouterKey() {
 ...
 */
export async function checkGraphiti() {
 ...
 */
export function formatOnboardingStatus(status) {
    const lines = [];
    // Header
    lines.push('═══════════════════════════════════════════════════════');
 ...
 */
export async function setOpenRouterKeyFromInput(key) {
    if (!key) {
 ...
 */
export async function setModelFromInput(modelId) {
    if (!modelId) {
